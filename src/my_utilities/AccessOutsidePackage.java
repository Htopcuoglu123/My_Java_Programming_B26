...
public class AccessOutsidePackage {
    ...
    //    System.out.println(AccessModifier.z);
        ...
        //c and z are private, so they can only be accessed
        // in the same class

        //b and y are default(Did not have any other access modifier)
        //so they can  only be accessed in the same package

        //so what is accessible outside a package; only public
    }
}
