...
public class Countries {
    public static void main(String[] args) {
        ...
        //created a HashMap that has key of String type-counties and ArrayList<String>for
        // the value and those will be cities
        ...
        for (ArrayList<String>cities:countries.values()){//iterates through the values of the map,
            // which are the ArrayList of cities
